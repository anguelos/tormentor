...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.attention_like = nn.Sequential(
    ...
    def forward(self, input):
        out_conv= self.double_conv(input)
        attn_input=torch.cat([input,out_conv], dim=1)
        out_conv = 2 * torch.tanh(self.attention_like(attn_input)) + out_conv
        self.relu(out_conv)
        return out_conv
